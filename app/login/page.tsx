  ...
  return (
    ...
    >
      ...
      <div className="absolute w-96 h-96 rounded-full top-20 -left-20 pointer-events-none"
        style={{ backgroundColor: "#DBEAFE", filter: "blur(80px)", opacity: 0.6, animation: "float 8s ease-in-out infinite" }} />
      <div className="absolute w-80 h-80 rounded-full bottom-20 right-10 pointer-events-none"
        style={{ backgroundColor: "#EEF2FF", filter: "blur(80px)", opacity: 0.5, animation: "float 8s ease-in-out infinite", animationDelay: "2s" }} />
      ...
      >
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-6" style={{ backgroundColor: "#EEF2FF" }}>
          ...
          <span className="text-xs font-semibold" style={{ color: "#1E3A8A" }}>{t.login.badge}</span>
        </div>

        <h1 className="font-bold text-3xl mb-2 leading-tight" style={{ fontFamily: "var(--font-poppins, Poppins, sans-serif)", color: "#111827" }}>
          {t.login.title}
        </h1>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="relative">
            <input
              ...
              style={{ backgroundColor: "#FAFAFA", border: "2px solid #E2E8F0", color: "#111827" }}
          ...
          <button
            ...
            style={{
              backgroundColor: loading ? "#818CF8" : "#1E3A8A",
              color: "#ffffff",
        ...
        <div className="text-center mt-6">
          <a href="/" className="text-xs font-medium transition-colors duration-200 hover:text-[#1E3A8A]" style={{ color: "#94A3B8" }}>
            ← Voltar ao início
          </a>
        </div>
      </div>
