...
const SECTION_KEYS: Array<keyof CaseStudy> = [
  "contexto", "objetivo", "meuPapel", "abordagem", "resultados", "materiais"
];
  ...
  return (
    <div style={{ backgroundColor: "#F8FAFC", minHeight: "100vh" }}>
      ...
      <div className="relative w-full overflow-hidden" style={{ height: "clamp(320px, 52vh, 600px)" }}>
        ...
        <div className="absolute bottom-0 left-0 right-0 px-6 lg:px-16 pb-12">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="font-bold leading-tight mb-4" style={{ fontFamily: "var(--font-poppins, Poppins, sans-serif)", fontSize: "clamp(1.8rem, 4.5vw, 3.5rem)", color: "#FFFFFF" }}>
              {title}
            </h1>
        ...
        <div className="absolute top-8 right-8 font-bold select-none" style={{ fontFamily: "var(--font-poppins, Poppins, sans-serif)", fontSize: "clamp(5rem, 12vw, 10rem)", color: "rgba(255,255,255,0.1)", lineHeight: 1 }}>
          {number}
        </div>
      </div>
      ...
      {SECTION_KEYS.map((key) => {
        ...
        const sectionDef = t.work_page.sections[key as keyof typeof t.work_page.sections];
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-16 py-16 md:py-20">
              <div className="grid lg:grid-cols-[220px_1fr] gap-10 lg:gap-20">
                <div className="lg:pt-1">
                  <p className="font-bold mb-1 leading-none" style={{ fontFamily: "var(--font-poppins, Poppins, sans-serif)", fontSize: "clamp(3.5rem, 6vw, 5rem)", color: `${accent}22` }}>
                    {num}
                  </p>
                  <div className="h-0.5 w-8 mb-3 rounded-full" style={{ backgroundColor: accent }} />
                  <p className="font-bold text-base mb-1" style={{ fontFamily: "var(--font-poppins, Poppins, sans-serif)", color: accent }}>
                    {label}
                  </p>
                ...
                <div>
                  {key === "resultados" ? (
                    <>
                      <p className="font-semibold mb-5 leading-snug" style={{ fontFamily: "var(--font-poppins, Poppins, sans-serif)", fontSize: "clamp(1.1rem, 2vw, 1.35rem)", color: "#1E293B" }}>
                        {content.split(".")[0]}.
                      </p>
                  ...
                  {key === "abordagem" && (
                    <div className="mt-6 rounded-2xl px-6 py-5 border-l-4" style={{ backgroundColor: "#F0FDFA", borderLeftColor: "#34D399" }}>
                      <p className="text-sm font-semibold mb-1" style={{ color: "#065F46" }}>{t.work_page.methodology}</p>
                      <p className="text-sm" style={{ color: "#0D9488" }}>{t.work_page.methodologyText}</p>
                    </div>
                  )}
                </div>
              </div>
      ...
      <section style={{ backgroundColor: "#FAFAF0" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-16 py-16 md:py-20">
          <div className="grid lg:grid-cols-[220px_1fr] gap-10 lg:gap-20">
            <div className="lg:pt-1">
              <p className="font-bold mb-1 leading-none" style={{ fontFamily: "var(--font-poppins)", fontSize: "clamp(3.5rem, 6vw, 5rem)", color: "#FBBF2422" }}>07</p>
              <div className="h-0.5 w-8 mb-3 rounded-full" style={{ backgroundColor: "#FBBF24" }} />
              <p className="font-bold text-base mb-1" style={{ fontFamily: "var(--font-poppins)", color: "#78350F" }}>{t.work_page.tools}</p>
              <p className="text-xs" style={{ color: "#94A3B8" }}>{t.work_page.toolsTagline}</p>
            </div>
            <div className="flex flex-wrap gap-3 content-start">
              {caseStudy.ferramentas.map((tool) => (
                <span key={tool} className="flex items-center gap-2 text-sm font-semibold px-5 py-3 rounded-2xl transition-all duration-200 hover:-translate-y-1" style={{ backgroundColor: "#FFFFFF", border: "2px solid #FFF6C9", color: "#1E293B", boxShadow: "0 2px 8px rgba(251,191,36,0.12)" }}>
        ...
        <section style={{ backgroundColor: "#FFFFFF" }}>
          <div className="max-w-7xl mx-auto px-6 lg:px-16 py-16 md:py-20">
            <div className="flex items-center gap-3 mb-10">
              ...
              <p className="font-bold text-sm uppercase tracking-[0.15em]" style={{ color: "#0C4A6E" }}>{t.work_page.gallery}</p>
              <span className="text-xs font-medium px-2.5 py-1 rounded-full" style={{ backgroundColor: "#C9E7FC", color: "#0C4A6E" }}>
                {gallery.length} {t.work_page.photos}
              </span>
            </div>
