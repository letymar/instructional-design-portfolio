        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              ...
              <span className="text-sm font-medium" style={{ color: "#5B4B8A" }}>Disponível para projetos</span>
            </div>
            ...
            <p className="text-base mb-8 max-w-md" style={{ color: "#64748B" }}>
              Disponível para projetos de design instrucional, LXD, formação
              e consultoria em EdTech.
            </p>
          ...
          <div className="hidden md:flex justify-end">
            ...
            >
              ...
              <p className="text-sm" style={{ color: "#64748B" }}>
                de experiência em design instrucional e tecnologia educativa
              </p>
            </div>
          </div>
        </div>
